...
class Challenge:
    ...
    def determine_winner(self):
        ...
        player_speed = self.player_pokemon.speed_at_lvl_50(self.player_pokemon.speed_stat_points)
        if (self.player_pokemon.beneficial_nature):
            player_speed *= 1.1
        if (self.player_pokemon.tailwind):
            player_speed *= 2

        villain_min_speed = self.villain_pokemon.speed_at_lvl_50(0)
        ...
        villain_max_speed = 1.1 * (self.villain_pokemon.speed_at_lvl_50(MAX_SPEED_STAT_POINTS))
